...
patch --no-backup-if-mismatch -p1 -d $VYOS_BUILD_ROOT/scripts/package-build/vyos-1x/vyos-1x < $PROJECT_ROOT/patches/vyos-1x/vyos-1x-007-landscape-integration.patch
